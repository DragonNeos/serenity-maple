        ...
        public static void Initialize()
        {
            ...
            catch
            {
                ...
                if (File.Exists("cached_keys.txt"))
                    ...
                    Console.WriteLine("Unable to load GMS Keys, because there were no cached keys stored and I failed retrieving them from the webserver! D:\r\nYou might want to check your internet connection and see if you can access http://direct.craftnet.nl/ directly.", "Problems!");
            }
            ...
            MapleStoryGlobalKeys.Add(28, new byte[] { //idk de key lel
                0x13,
                0x08,
                0x06,
                0xB4,
            ...
            Debug.WriteLine("Done loading keys.");
        }
